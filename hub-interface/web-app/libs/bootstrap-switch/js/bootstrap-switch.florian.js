...
//FLORIAN MODIFICATION: skip disables/readonly check
...
//FLORIAN MODIFICATION: new function to include disables/readonly check
      BootstrapSwitch.prototype.clickState = function(value, skip) {
        if (typeof value === "undefined") {
          return this.options.state;
        }
        if (this.options.disabled || this.options.readonly) {
...
//FLORIAN MODIFICATION  _this.clickState(false); instead of  _this.state(false);
        ...
        return this.$off.on("click.bootstrapSwitch", (function(_this) {
          return function(event) {
            event.preventDefault();
            event.stopPropagation();
//FLORIAN MODIFICATION  _this.clickState(true); instead of  _this.state(true);
